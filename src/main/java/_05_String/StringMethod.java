...
public class StringMethod {
    public static void main(String[] args) {
        /*
        - 자료형 분휴
        1. 첫 글자가 소문자인 자료형 : 원시자료형
            -> int, double, long, boolean 등
        2. 첫 글자가 대문자인 자료형 : 참조자료형
            -> Scanner, String, Array, 클래스 등

        - JVM(java virtual machine) : class 파일을 읽고 os에 명령을 내리는 주체
        - JVM의 메모리구조
        1. Stack(스택)
            - 원시자료형(소문자 시작)의 실제 값이 저장됨
            - 참조자료형의 메모리 주소(Heap에 있는 주소)가 저장됨
        2. Heap(힙)
            - 실제 참조자료형의 실제 값이 저장됨
        ...
        // 참고) 메모리주소는 16진수("0x"로 시작 - 0x00007FEDEA2...)
        ...
        // 아니면 제 3의 주소에 지정된 값일까?
        System.out.println("안녕하세요" + "반갑습니다."); // 연결됨

        // 다른 자료형과도 덧셈 가능
        // 덛쎔연산 시 다른 자료형이 문자열로 변환됨
        System.out.println("점수 : " + 100 + "점"); // 100은 int 자료형

        // 주의 : 연산자 우선순위
        // ()가 1등, 대입이 마지막 / 동등할 경우 왼쪽에서 오른쪽으로 진행
        // 다른 자료형과 문자열 연산 시 우선순위 주의
        ...
        // 순서를 index라고 부른다. - 0부터 카운트한다.
        String str = "My name is Son";

        // 4. 문자열 길이 확인 // 결과타입 : 정수(int)
        str.length(); // 문자열의 문자 갯수를 가져온다
        System.out.println("문자열 길이 : " + str.length());

        // 5. 대소문자 변환 // 결과타입 : 문자열(String)
        ...
        str = "We study Java";
        // 7. 특정 문자열이 어디서 시작하는지(index) 찾기 // 결과값 : int
        System.out.println(str.indexOf("Study")); // index 3에서부터 시작
        System.out.println(str.indexOf("Python")); // 없으면 -1을 가져옴
